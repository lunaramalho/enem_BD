...
if __name__ == "__main__":
    ...
    pasta_local = 'C:/Users/lunas/Downloads/enem2015/parquet_chunks'


    #Nome do seu bucket
    bucket ='enemm2015_bucket'
    # pasta dentro do bucket para onde os arquivos vão
    pasta_destino = 'bronze/parquet'  
    # Sua chave de autenticacao do servico
    caminho_chave = 'C:/Users/lunas/Downloads/enem2015/chave/analauramagalhaes-lunaramalho-43207bea500d.json'
