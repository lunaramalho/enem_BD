...
if __name__ == "__main__":
    ...
    chave_json = 'C:/Users/lunas/Downloads/enem2015/chave/analauramagalhaes-lunaramalho-43207bea500d.json'

    # Parâmetros para dados particionados
    formato_entrada = 'parquet'
    caminho_particionado = 'bronze/parquet/MICRODADOS_ENEM_2015_chunk_'
